   ...
   .btn-black{
      ...
      <div class="sidenav d-none d-sm-block">
         <div class="login-main-text">
            <h2>Bienvenida a<br>VAN-TEC<br>GESTIONA</h2>
            <p>El Sistema para <br> Consultoras Independientes <br> Mary Kay</p>
         </div>
      </div>
      <div class="main">
         <div class="col-md-6 col-sm-12">
            <div class="login-form">
               ...
               <br>
               <p>Creado por Vandreh Esmeraldo.<br> WhatsApp +55 85 99227-7582</p>
            </div>
         </div>
      </div>
