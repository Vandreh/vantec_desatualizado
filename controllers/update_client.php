<?php  
	...
	include_once $project_path."/models/managerclient.php";
	...
	update("tb_clientes", $data, array("id_cliente"=>$data['id_cliente']));

	# Redirecionamento
	header("location: $project_index/".$user['profile_page']."?option=manager_clients&success=update_ok");	
